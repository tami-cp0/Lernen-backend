...
class SuccessfulUpload {
  @ApiProperty({ example: 'doc-123e4567-e89b-12d3-a456-426614174000', description: 'Document ID' })
  id: string;
...
class FailedUpload {
  @ApiProperty({ example: 'failed-document.pdf', description: 'Original filename that failed to upload' })
  name: string;
...
export class UploadDocumentResponseDTO {
  ...
  @ApiProperty({ 
    example: 2, 
    description: 'Number of remaining upload slots for this chat (max 3 total)' 
  })
